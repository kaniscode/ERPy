...
## 1.1.0rc1 — manuscript release candidate (prepared locally)
...
The preceding public release is retained in Git history. It does not contain all manuscript corrections or the development modes above.
