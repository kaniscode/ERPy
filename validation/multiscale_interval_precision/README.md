...
The CSV retains all comparison estimates, endpoints and diagnostic probabilities.
The fixed source tables and plan remain available alongside their source hashes.
No private recordings are needed to inspect these numerical results.
